        ...
        <form action="" method="post" class="form form-horizontal uploadForm" id="form-member-add" enctype="multipart/form-data">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="请输入比赛名称" id="math_name" name="math_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>比赛日期：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="laydate_date" name="date">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>比赛时间：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="laydate_time" name="time">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" >
                        <select class="select" name="stage" size="1">
                            ...
                            <option value="1">小组第一轮</option>
                            <option value="2">小组第二轮</option>
                            <option value="3">小组第三轮</option>
                            <option value="4">淘汰赛</option>
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" >
                        <select class="select" name="item" size="1">
                            ...
                            <option value="6">男团</option>
                            <option value="7">女团</option>
                        </select>
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="请输入比赛国家" id="nation" name="nation">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                    <input class="btn btn-primary radius submit" type="button" value="&nbsp;&nbsp;立即提交&nbsp;&nbsp;" onclick="insert()">
